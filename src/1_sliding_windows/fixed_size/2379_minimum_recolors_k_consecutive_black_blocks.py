...
'W' or 'B', representing white and black blocks respectively. You are also given
an integer k, which is the desired number of consecutive black blocks.

In one operation, you can recolor a white block to a black block.
...
Output: 0
Explanation:
No changes are needed. There are already 2 consecutive black blocks.
"""
